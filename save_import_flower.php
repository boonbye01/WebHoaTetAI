...
try {
    ...
    $insert = $pdo->prepare(
        'INSERT INTO nhap_vuon_ngoai (loai_hoa_id, so_luong_cap, don_gia_lay, ten_nha_vuon, ghi_chu, ngay_nhap, created_at)
         VALUES (?, ?, ?, ?, ?, ?, NOW())'
    );
    $insert->execute([$loai_hoa_id, $so_luong_cap, $don_gia_lay, $ten_nha_vuon, $ghi_chu, $ngay_nhap]);
